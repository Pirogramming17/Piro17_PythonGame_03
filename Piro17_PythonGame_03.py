...
class Game:
    ...
    def game(self):
      ...
      self.player.append(Player("심은서", 3, 0))
      self.player.append(Player("박예진", 2, 0))
      self.player.append(Player("조연서", 3, 0))
      self.player.append(Player("조하연", 4, 0))
      self.player.append(Player("이헌도", 2, 0))
      self.player.append(Player("사용자", 1, 0))
